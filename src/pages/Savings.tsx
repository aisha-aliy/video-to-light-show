    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 sm:px-6 pt-24 sm:pt-32 pb-12 sm:pb-20">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold">
            Save smarter, earn <span className="text-primary text-glow">15% interest</span>
          </h1>
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
            Automated savings with competitive interest rates. Set goals, lock funds, and watch your money grow securely.
          </p>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8 mt-12 sm:mt-20 text-center">
          <div>
            <div className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 text-primary">15%</div>
            <div className="text-xs sm:text-sm text-muted-foreground">Annual Interest</div>
          </div>
          <div>
            <div className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 text-primary">₦0</div>
            <div className="text-xs sm:text-sm text-muted-foreground">Minimum Balance</div>
          </div>
          <div>
            <div className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 text-primary">Daily</div>
            <div className="text-xs sm:text-sm text-muted-foreground">Interest Calculation</div>
          </div>
          <div>
            <div className="text-2xl sm:text-4xl font-bold mb-1 sm:mb-2 text-primary">NDIC</div>
            <div className="text-xs sm:text-sm text-muted-foreground">Insured</div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-20">
        <div className="text-center mb-8 sm:mb-12">
          <Badge variant="outline" className="rounded-full mb-4">Savings Options</Badge>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            Choose the perfect <span className="text-primary text-glow">savings plan</span>
          </h2>
        </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-20 bg-secondary/5 rounded-3xl">
        <div className="text-center mb-8 sm:mb-12">
          <Badge variant="outline" className="rounded-full mb-4">Smart Features</Badge>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto">
          <Card className="p-6 hover:border-primary transition-colors">
            ...
            <p className="text-muted-foreground">
              Automatically save a percentage of your income or set amount daily/weekly.
            </p>
          </Card>
          ...
          <Card className="p-6 hover:border-primary transition-colors">
            ...
            <p className="text-muted-foreground">
              Choose daily, weekly, or monthly saving schedules that work for you.
            </p>
          </Card>
        ...
        <Card className="max-w-3xl mx-auto p-8 sm:p-12 gradient-primary-pink text-white">
          <div className="text-center mb-8">
            ...
            <p className="text-base sm:text-lg text-white/90">
              Save ₦10,000 monthly and earn ₦127,680 interest in one year with our 15% fixed savings plan.
            </p>
          </div>
