    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold">
              Accept payments <span className="text-primary text-glow">anywhere</span>
            </h1>
            <p className="text-base sm:text-lg text-muted-foreground">
              Get a free POS terminal and start accepting card payments from your customers. Instant settlement, real-time tracking, and zero setup cost.
            </p>
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-20">
        <div className="text-center mb-8 sm:mb-12">
          <Badge variant="outline" className="rounded-full mb-4">Terminal Features</Badge>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            Powerful features for <span className="text-primary text-glow">modern businesses</span>
          </h2>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <Card className="p-6 hover:border-primary transition-colors">
            ...
            <p className="text-muted-foreground">
              Funds settle directly to your account instantly after each transaction.
            </p>
          </Card>
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-20 bg-secondary/5 rounded-3xl">
        <div className="text-center mb-8 sm:mb-12">
          <Badge variant="outline" className="rounded-full mb-4">Easy Setup</Badge>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            Get started in <span className="text-primary text-glow">3 simple steps</span>
          </h2>
        </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-20">
        <div className="text-center mb-8 sm:mb-12">
          <Badge variant="outline" className="rounded-full mb-4">Simple Pricing</Badge>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            Transparent pricing with <span className="text-primary text-glow">no surprises</span>
          </h2>
        </div>
